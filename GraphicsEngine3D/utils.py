...
def get_demo_data_for_plans():
    folder = Path(__file__).parents[1]/'demo/demo_Mate'
    ...
    plans = [{'id':'radar_0', 'type':'radar', 'path':path1,'color':(255,0,0,0.5),'world_dimensions':world_dim, 'dimension':80e3},
