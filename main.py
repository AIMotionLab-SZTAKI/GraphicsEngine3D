...
def main():
    ...
    parser.add_argument('--folder', type=str, default=root_dir/'demo/demo_MinSnap', 
                        help='Folder containing the grid_seq.npy, paths_dict.pkl, terrain.npy, and terrain.png files')
    parser.add_argument('--scene', type=eval, default=['all'],
                        help='''List containing scene objects to be plotted ['all', 'grid', 'plans', 'terrain']''')
...
# python GraphicsEngine3D/main.py --scene ['plans','terrain']